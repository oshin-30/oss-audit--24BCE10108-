...
# Here we use a function to demonstrate the same idea
say() { echo "$1"; }
...
# --- read: gets input from the user interactively ---
...
echo "That is the same freedom that open source software protects —" >> "$OUTPUT"
